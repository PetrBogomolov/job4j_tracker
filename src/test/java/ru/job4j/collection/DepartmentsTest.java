...
public class DepartmentsTest {
    ...
    @Test
    public void whenSortAscendingSuccesfully() {
        List<String> input = Arrays.asList(
                "K1/SK1/SSK1", "K1/SK1", "K1", "K1/SK1/SSK2",
                "K1/SK2", "K2/SK1/SSK2", "K2/SK1/SSK1",
                "K2/SK1", "K2"
        );
        Departments.sortAscending(input);
    ...
    @Test
    public void whenSortDescendingSuccesfully() {
        List<String> input = Arrays.asList(
                "K1", "K1/SK1", "K1/SK1/SSK1", "K1/SK1/SSK2",
                "K1/SK2", "K2", "K2/SK1", "K2/SK1/SSK1",
                "K2/SK1/SSK2"
        );
        Departments.sortDescending(input);
        List<String> expect = Arrays.asList(
                "K2",
                "K2/SK1",
                "K2/SK1/SSK1",
